...
const Button = () => {
    ...
    return(
        <section className={clsx(
            "w-3/4 h-2/3 pt-8 px-14 flex flex-col space-y-5 mx-auto" )}>
                <div className="h-1/2 w-full flex flex-row space-x-5 mx-auto items-end">
                    <div className="w-[70%] h-full relative shadow-md rounded-sm mx-auto bg-[url('/img/intro_bg.jpg')] bg-cover bg-no-repeat"
                    >
                    ...
                    <div className="w-[70%] h-full relative shadow-md rounded-sm mx-auto bg-[url('/img/exhibit_bg.jpg')] bg-cover bg-no-repeat"
                    >
                        <div className="absolute inset-0 w-full h-full bg-black opacity-10" />
                ...
                <div className="h-1/2 w-full flex flex-row space-x-5 mx-auto items-end">
                    <div className="w-[70%] h-full relative shadow-md rounded-sm mx-auto bg-[url('/img/chat_bot_button_2.png')] bg-cover bg-no-repeat"
                    ...
                    <div className="w-[70%] h-full relative shadow-md rounded-sm mx-auto bg-[url('/img/education_bg.jpg')] bg-cover bg-repeat"
                    >
                        <div className="absolute inset-0 w-full h-full bg-black opacity-10" />
