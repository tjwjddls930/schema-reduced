...
const Viewcontent = ({url, width, height}) => {
    ...
    return(
        ...
        <>
        {isClient && (
        <div className={clsx("absolute h-full w-full md:h-screen md:w-screen bottom-16 left-1/2 transform -translate-x-1/2")}>
            <div className="h-12 w-12 md:h-[50px] md:w-[50px] z-10 absolute bottom-12 right-16 md:bottom-20 md:right-20 border-2 border-black rounded-full bg-blue-500"
                onClick={()=> setColor("#5c92de")}
            />
            <div className="h-12 w-12 md:h-[50px] md:w-[50px] z-10 absolute bottom-12 right-32 md:bottom-20 md:right-64 border-2 border-black rounded-full bg-white"
