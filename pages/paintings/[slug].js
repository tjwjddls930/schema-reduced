...
export default function Paintings() {
    ...
    return(
        ...
        {data && (
            ...
            {popup && (
                <div className="absolute bg-black bg-opacity-40 h-[91%] w-[600px] bottom-16 left-1/2 transform -translate-x-1/2"
                ...
                >
                    <div className="w-5/6 h-5/6 flex flex-col space-y-32 px-4 mt-16 mx-auto items-center justify-end text-center">
                        ...
                        <div className="flex flex-col space-y-2 mx-auto w-full">
                            ...
                            <span className="text-white font-bold text-base">{popupText[language]}</span>
                        </div>
                        <div className="flex flex-col w-full mx-auto">
                            <div className="flex justify-between w-full">
                                <div className="flex flex-col space-y-2">
                                    <span className="font-bold text-white text-lg">{data.name}</span>
                                    <span className="font-bold text-white text-base">{data.overview}</span>
                                    <span className="font-bold text-white text-base">{data.overview1}</span>
                                </div>
                                <span className="font-bold text-white text-5xl">{data.order}{'.'}</span>
                            </div>
